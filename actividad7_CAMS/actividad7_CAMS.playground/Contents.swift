...
func cambioString (c:String, d:String) -> (String, String){
    var c:String = c
    var d:String = d
...
print(cambioString(c: "DatoC", d: "DatoD"))
...
extension Array {
    ...
    func newTransform (datos:[Int], datos2:[Int]) -> ([Int], [Int]){
        var datos:[Int] = datos
...
print(datos.newTransform(datos:[3,7,9,2], datos2:datos.map{$0*5}))
/*:
### Biblioteca de Swift
